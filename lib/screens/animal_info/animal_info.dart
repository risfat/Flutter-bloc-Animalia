  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        if (info.fields.contains('Slogan'))
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (info.fields.contains('Class')) SizedBox(height: 10),
                  if (info.fields.contains('Scientific Name'))
                    Padding(
                  ...
                  if (info.fields.contains('Scientific Name'))
                    SizedBox(height: 10),
                  if (info.fields.contains('Common Name'))
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 12.0),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  if (info.fields.contains('Common Name')) SizedBox(height: 10),
                  if (info.fields.contains('Group'))
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 12.0),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  if (info.fields.contains('Group')) SizedBox(height: 10),
                  if (info.fields.contains('Lifespan'))
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 12.0),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  if (info.fields.contains('Lifespan')) SizedBox(height: 10),
                  if (info.fields.contains('Diet'))
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 12.0),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  if (info.fields.contains('Diet')) SizedBox(height: 10),
                  if (info.fields.contains('Weight'))
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 12.0),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  if (info.fields.contains('Weight')) SizedBox(height: 10),
                  if (info.fields.contains('Location'))
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 12.0),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  if (info.fields.contains('Location')) SizedBox(height: 10),
                ],
              ),
            ),
          ),
